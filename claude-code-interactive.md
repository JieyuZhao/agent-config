...
| Shortcut     | Description            | Notes                                                                    |
| :----------- | :--------------------- | :----------------------------------------------------------------------- |
| Hold `Space` | Push-to-talk dictation | Requires voice dictation to be enabled. Transcript inserts at cursor.    |
...
See the commands reference at https://code.claude.com/docs/en/commands for the full list.
